...
namespace EpicBattle.Models.RPG
{
    ...
    public static class SkillsDatabase
    {
        ...
        {
            // --- Путь Меча ---
            new Skill { Id = "S1_PowerStrike", Name = "Мощный Удар", Description = "Наносит 150% физического урона.", Branch = SkillBranch.SwordPath, Type = SkillType.Active, ManaCost = 10 },
            new Skill { Id = "S2_Cleave", Name = "Рассечение", Description = "Атака, накладывающая эффект кровотечения (урон каждый ход).", Branch = SkillBranch.SwordPath, Type = SkillType.Active, RequiredLevel = 3, RequiredSkillId = "S1_PowerStrike", ManaCost = 15 },
            ...
            // --- Тайные Искусства ---
            new Skill { Id = "M1_Fireball", Name = "Огненный Шар", Description = "Наносит магический урон и с небольшим шансом поджигает врага.", Branch = SkillBranch.ArcaneArts, Type = SkillType.Active, ManaCost = 15 },
            new Skill { Id = "M2_ManaShield", Name = "Щит Маны", Description = "В течение 3 ходов 50% получаемого урона поглощается за счет маны.", Branch = SkillBranch.ArcaneArts, Type = SkillType.Active, RequiredLevel = 3, RequiredSkillId = "M1_Fireball", ManaCost = 20, Cooldown = 5 },
            ...
            // --- Выживание ---
            new Skill { Id = "V1_FirstAid", Name = "Первая Помощь", Description = "Восстанавливает 30 HP. Не тратит зелья.", Branch = SkillBranch.Survival, Type = SkillType.Active, ManaCost = 10, Cooldown = 3 },
